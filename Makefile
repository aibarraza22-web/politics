...
# Real mode: needs EIA_API_KEY/NREL_API_KEY in .env and network access.
# NOTE: fetchers are still unverified-live (see SOURCES.md) — inspect raw
# responses on first run.
real:
